...
const char* ssid = "มาสเตอร์";  // เปลี่ยนข้อความได้
const char* password = "12345678";  //เปลี่ยนรหัสได้

/* Put IP Address details */// ค่าตำแหน่ง IP เปลี่ยนได้ตามหลักการระบบเครือข่าย
IPAddress local_ip(192,168,1,2); //ให้นักเรียนเปลี่ยนเลขตัวท้าย ip (0-255)
